...
const routeData = {
    ...
    3: {
        ...
        stops: [
            ...
            { name: "Celler Can Ripoll", lat: 39.7200, lng: 2.9130, type: "restaurant", description: "Inca — El celler más histórico y famoso de Mallorca — Cocina tradicional desde siempre" }
        ]
    }
};
...
// NOTE: Para no duplicar aquí todo el archivo, se aplicará un parche mínimo en la sección acordeón del panel de progreso.
